...
import { Layout, Plus, Layers, Folder, Trash2, Heart, Link as LinkIcon, Settings, Shield, ArrowDownAZ, ArrowUpNarrowWide, Github, ChevronsUp, ChevronLeft, ChevronRight, FolderInput, X, Check } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  // New: State for the "Move Board" modal
  ...
  // New: Handle moving via Modal
  const handleMoveBoard = (boardId: string, collectionId?: string) => {
      // Note: Passing undefined/null for collectionId moves it to "Unorganized"
    ...
    <>
                ...
                <div className="p-2 max-h-[60vh] overflow-y-auto custom-scrollbar">
                    ...
                    {collections.map(col => (
                        <button 
                            ...
                            className="w-full text-left px-4 py-3 rounded-xl hover:bg-slate-900 text-slate-300 flex items-center gap-3 transition-colors group"
                        >
                            <Layers size={18} className="text-slate-500 group-hover:text-teal-500 transition-colors" />
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar px-3 py-2 space-y-8">
            ...
            {/* Collections & Boards (Hidden when collapsed) */}
                                ...
                                <ul className="ml-4 mt-0.5 border-l border-slate-800 pl-2 space-y-0.5">
                                    {sortedBoards(boards.filter(b => b.collectionId === col.id)).map(board => (
                                        ...
                                        >
                                            ...
                                            {/* Hover Actions (Share, Move, Delete) */}
